...
- `13-code-node-lambda-sandbox.md` — Code node → `data-transformer-executor` Lambda; four sandbox layers
- `14-node-timeout-retry-errors.md` — `BaseNode.run` timeout / retry / error strategy; known gaps
